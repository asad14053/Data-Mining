...
def random_dna():
    ...
    # Task -02: randomly generate 1000 DNA sequence because we are considering 3 sequence at a time, so loop will continue 333
    full_seq = ''
    for i in range (1,333):
        ...
        modulo = int(n % 64)
        full_seq = full_seq + ran2dna[modulo]

    print("Random Sequence: ", full_seq)
    ...
    # Task-05 Find average Protein length
    mean = math.ceil(avg_len/no_pro)
    print("Average Protien length: ", mean)

    # Task-06 standard deviation of protein length
    print("Protein length Standard Deviation: ", math.ceil(stdev(len_list, no_pro)))
